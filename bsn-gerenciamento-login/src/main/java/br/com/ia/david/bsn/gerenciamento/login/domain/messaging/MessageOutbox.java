...
/**
 * Classe utilitária para definir as configurações de envio de mensagens
 *   de acordo com o padrão de mensagem definido no projeto.
 *
 * Padrão de routingKey de eventos: "consumer.chave-do-evento.message"
 * Padrão de exchange de eventos: "consumer.exchange"
 */
@Getter
