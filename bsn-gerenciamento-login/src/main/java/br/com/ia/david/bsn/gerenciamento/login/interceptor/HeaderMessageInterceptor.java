...
public class HeaderMessageInterceptor implements MethodBeforeAdvice, MessagePostProcessor {
     ...
     *
     *   <br/><br/>Seta os headers da mensagem de entrada num {@link ThreadLocal},
     *     possibilitando recuperar as informações dentro da thread atual.
     */
    @Override
     ...
     *
     *   <br/><br/>Aplica os headers salvos na thread local (caso existam) nos headers da mensagem de saída.
     *     São adicionados somente os headers que:<ul>
     *       <li>Não comecem com <strong>__</strong>;</li>
     *       <li>Não existam na mensagem original.</li>
     *     </ul>
     */
    @Override
