...
import static br.com.ia.david.bff.gerenciamento.login.domain.messaging.Messaging.AMQ_TOPIC;
import static br.com.ia.david.bff.gerenciamento.login.domain.messaging.Messaging.GFE;
...
public class ListenerExceptionInterceptor implements ThrowsAdvice {
     ...
     * aqui.</em>
     *
     * @see #afterThrowing(org.springframework.amqp.core.Message, Throwable)
     */
    @Async
    @SneakyThrows
    ...
    public void afterThrowing(final org.springframework.amqp.core.Message message, final Throwable th) {
        ...
        rabbitTemplate.send(AMQ_TOPIC, GFE.getRoutingKey(), withBody(objectMapper.writeValueAsBytes(mappedMessage.build()))
    ...
    protected static class Message implements Serializable {
        ...
        private final long serialVersionUID = -1471079143761520862L;
