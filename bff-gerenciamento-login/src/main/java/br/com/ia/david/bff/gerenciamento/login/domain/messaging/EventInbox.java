...
/**
 * Classe utilitária para definir as configurações de recebimento de eventos
 *   de acordo com o padrão de mensagem definido no projeto.
 *
 * Padrão de routingKey de eventos: "producer.chave-do-evento.finished.event"
 * Padrão de exchange de eventos: "producer.events.exchange"
 * Padrão de queue para eventos: "consumer.chave-do-evento.reply.queue"
 *
 */
@Getter
public class EventInbox {
    ...
    public EventInbox(String routingKey) {
        ...
        this.queue = String.format("%s.%s.reply.queue", Messaging.EXCHANGE.split("\\.")[0], message(routingKey));
    }
